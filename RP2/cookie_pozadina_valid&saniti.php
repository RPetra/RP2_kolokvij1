...
<body>
	...
	<h3> ZADATAK: Korigirajte kod cookie_pozadina.php tako da napravite sanitizaciju i validaciju
			podataka koje skripta dobiva od korisnika:</h3>
	<ul>
		<li>Kao unos u textbox, dozvolite samo znak # iza kojeg slijedi tro- ili
			šesteroznamenkasti hex kod boje.</li>
		<li>Kao unos u select, dozvolite samo riječi sastavljene od max 20
			slova engleske abecede.</li>
	</ul>
